# main.py — Entry point for the Hack-A-Bot Catapult
# ====================================================
# This is the file that runs on boot.
# It imports all modules and orchestrates the autonomous sequence.
#
# File structure:
#   config.py    — All pins, constants, calibration values
#   servo.py     — Positional + continuous rotation servo control
#   stepper.py   — NEMA 17 turret rotation with acceleration
#   sensors.py   — VL53L0X ToF distance sensor
#   display.py   — SSD1306 OLED screen
#   scanner.py   — 360° sweep scan and tower detection
#   launcher.py  — Arm, latch, magazine, firing sequence
#   calibrate.py — Interactive calibration shell
#   main.py      — THIS FILE: mode select + autonomous mode
